...
// 		});
	...
	function AjaxData(){
		 $.ajax({
            ...
            async:false,
	    cache:true,
            url : "http://smms.idc.com/SMMS/SMMS/SmmsEventMainBiz/getStatJson",
//             url:"data.json",
            dataType:"json",
