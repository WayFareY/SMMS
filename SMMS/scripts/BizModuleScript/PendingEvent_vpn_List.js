...
function viewContentPath(contentPath){
	var obj = getDataMapObj('PendingEvent_vpn.selectContentPathByRid&RID='+contentPath);
	if(obj.SNAPSHOP != 'null' && obj.SNAPSHOP !='' && obj.SNAPSHOP != null){
		var url = rootPath+"/SMMS/PendingEvent_vpnBiz/PendingEventVpn?RID="+contentPath;
		openWindow(url);}
}