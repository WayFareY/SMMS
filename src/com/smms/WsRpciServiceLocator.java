...
public class WsRpciServiceLocator
  extends Service
  implements WsRpciService
{
  ...
  public WsRpciServiceLocator(String wsdlLoc, QName sName)
  ...
  public WsRpci_client getWsRpci(URL portAddress)
    throws ServiceException
  {
    try
    {
