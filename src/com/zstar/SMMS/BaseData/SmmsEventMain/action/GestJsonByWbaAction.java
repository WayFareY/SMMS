...
public class GestJsonByWbaAction
  extends FrameAction
{
    ...
    throws Exception
  {
    ...
    if (("1".equals(ygt)) && (ygt != null) && ("2".equals(yxf)) && (yxf != null)) {
      codition = " and ( RECTIFY_STATE='888' or RECTIFY_STATE='020' or RECTIFY_STATE='010' )";
    }
    ...
    FMPLog.debug("WCL:" + wcl + "===" + "YGT:" + ygt + "===" + "YXF:" + yxf + "===" + "未备案的condition：" + codition);
    
    GetCountCitySumDel del = new GetCountCitySumDel(this.contex);
    String json = del.getWbaJson(codition);
    setMsg(json);
    return "empty";
  }
}
