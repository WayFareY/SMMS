...
public class SandSmmsPendingEventAction
  extends FrameAction
{
    ...
    throws Exception
  {
    ...
    List<Map<String, Object>> dataList = this.sqlSession.selectList("SmmsEventMain.viewToRectify", mapRid);
