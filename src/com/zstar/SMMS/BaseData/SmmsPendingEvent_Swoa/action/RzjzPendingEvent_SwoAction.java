package com.zstar.SMMS.BaseData.SmmsPendingEvent_Swoa.action;
...
public class RzjzPendingEvent_SwoAction extends FrameAction {

	public RzjzPendingEvent_SwoAction() {
	}
	...
	public String bizExecute() throws Exception {
		...
		ridMap.put("RID", rid);
		Map map = (Map) sqlSession.selectOne("SmmsPendingEvent_Swo.selectContentPathByRid", ridMap);
