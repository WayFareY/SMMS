...
public class RzjzPendingEvent_keyAction extends FrameAction {

	public RzjzPendingEvent_keyAction() {
	}
	...
	public String bizExecute() throws Exception {
		...
		ridMap.put("RID", rid);
		Map map = (Map) sqlSession.selectOne("PendingEvent_key.selectContentPathByRid", ridMap);
