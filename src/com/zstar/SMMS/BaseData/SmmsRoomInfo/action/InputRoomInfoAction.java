...
public class InputRoomInfoAction
  extends FrameAction
{
    ...
    if ((listMap != null) && (!listMap.isEmpty()))
    {
      ...
      if ((!"".equals(result)) && (result != null))
      {
        ...
        for (int k = 2; k < result.size(); k++) {
          try
          {
            String jfmc = ((ArrayList)result.get(k)).get(((Integer)map.get("ROOM_NAME")).intValue()).toString().replace(" ", "");
            String jfxh = ((ArrayList)result.get(k)).get(((Integer)map.get("ROOM_IDX")).intValue()).toString().replace(" ", "");
            String jfszd = ((ArrayList)result.get(k)).get(((Integer)map.get("ROOM_ADDRESS")).intValue()).toString().replace(" ", "");
            String jfxz = ((ArrayList)result.get(k)).get(((Integer)map.get("ROOM_PROPERTY")).intValue()).toString().replace(" ", "");
            
            String fzr = ((ArrayList)result.get(k)).get(((Integer)map.get("ROOM_MANAGER")).intValue()).toString().replace(" ", "");
            String fzrdh = ((ArrayList)result.get(k)).get(((Integer)map.get("MANAGER_TEL")).intValue()).toString().replace(" ", "");
            String fzrsj = ((ArrayList)result.get(k)).get(((Integer)map.get("MANAGER_MOBILE")).intValue()).toString().replace(" ", "");
