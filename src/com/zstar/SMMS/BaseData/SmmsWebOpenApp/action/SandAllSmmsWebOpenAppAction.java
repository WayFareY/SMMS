...
public class SandAllSmmsWebOpenAppAction
  extends FrameAction
{
  public String bizExecute()
    throws Exception
  {
    List dataList = this.sqlSession.selectList("SmmsWebOpenApp.sendList");
    for (Object listAll : dataList)
    {
      Map jsonMap = (Map)listAll;
