package com.zstar.SMMS.acLog.SmmsAcAppVpn.action;
...
public class AcAppVpnRzjzAction extends FrameAction {

	public AcAppVpnRzjzAction() {
	}
	...
	public String bizExecute() throws Exception {
		...
		ridMap.put("RID", rid);
		Map map = (Map) sqlSession.selectOne("SmmsAcAppVpn.selectContentPathByRid", ridMap);
		String groupName = (String) map.get("GRUOPNAME");
