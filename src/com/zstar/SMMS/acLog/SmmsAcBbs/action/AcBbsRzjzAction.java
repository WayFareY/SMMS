package com.zstar.SMMS.acLog.SmmsAcBbs.action;
...
public class AcBbsRzjzAction extends FrameAction {

	public AcBbsRzjzAction() {
	}
	...
	public String bizExecute() throws Exception {
		...
		ridMap.put("RID", rid);
		Map map = (Map) sqlSession.selectOne("SmmsAcBbs.selectContentPathByRid", ridMap);
