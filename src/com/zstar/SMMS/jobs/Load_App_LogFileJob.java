...
public class Load_App_LogFileJob extends BaseJob {

	public Load_App_LogFileJob() {
	}
	...
	public void jobExcute(String arg0) throws JobExecutionException {
		...
		while (iterator.hasNext()) {
			...
			while (iterator1.hasNext()) {
				...
				if (!fileName.startsWith("app") || !fileName.endsWith(".mdf.ok")) {
				...
				try {
					...
					String tableRow = "USERNAME,GROUPNAME,IP,SERV_CRC,APP_CRC,LOG_TIME,DES_IP,DES_PORT";
					String sqlId = "SmmsAcApp.insertSave";
					ReadAcLogDel del = new ReadAcLogDel(contex);
					dbsqlSession.delete("SmmsAcApp.deleteAll");
