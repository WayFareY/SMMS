...
public class Load_App_Vpn_LogFileJob extends BaseJob {

	public Load_App_Vpn_LogFileJob() {
	}
	...
	public void jobExcute(String arg0) throws JobExecutionException {
		...
		while (iterator.hasNext()) {
			...
			while (iterator1.hasNext()) {
				...
				if (!fileName.startsWith("vpn") || !fileName.endsWith(".mdf.ok")) {
				...
				try {
					...
					String tableRow = "USERNAME,GROUPNAME,IP,SERV_CRC,APP_CRC,LOG_TIME,DES_IP,DES_PORT,VPN_PROXY";
					String sqlId = "SmmsAcAppVpn.insertSave";
