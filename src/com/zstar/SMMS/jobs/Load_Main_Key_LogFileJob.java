...
public class Load_Main_Key_LogFileJob extends BaseJob {

	public Load_Main_Key_LogFileJob() {
	}
	...
	public void jobExcute(String arg0) throws JobExecutionException {
		...
		while (iterator.hasNext()) {
			...
			while (iterator1.hasNext()) {
				...
				if (!fileName.startsWith("keyword_mail") || !fileName.endsWith(".mdf.ok")) {
				...
				try {
					...
					String tableRow = "USERNAME,GROUPNAME,IP,SERV_CRC,APP_CRC,LOG_TIME,CONTENT,TITLE,MAIL_FROM,MAIL_TO,KEYWORDS,EVENT_EVIDENCE";
					String sqlId = "SmmsAcMailKey.insertSave";
