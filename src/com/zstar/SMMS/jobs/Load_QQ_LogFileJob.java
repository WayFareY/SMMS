...
public class Load_QQ_LogFileJob extends BaseJob {
	...
	public void jobExcute(String arg0) throws org.quartz.JobExecutionException {
		...
		while (iterator.hasNext()) {
			...
			while (iterator1.hasNext()) {
				...
				if (!fileName.startsWith("qq_count") || !fileName.endsWith(".mdf.ok")) {
				...
				try {
					...
					String tableRow = "IP,EVENT_INDEX";
					ReadAcLogDel del = new ReadAcLogDel(contex);
					int sum = del.insertAcLogin(filePath, mdfPath, tableRow, "", true);
					FMPLog.debug((new StringBuilder("sum:")).append(sum).toString());
					String logFlag = "080";
